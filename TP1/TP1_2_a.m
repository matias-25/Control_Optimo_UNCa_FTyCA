...
subplot(2,1,1); plot(phi);grid on; title('phi');xlabel('tiempo [seg]'); grid on;
subplot(2,1,2);plot(d);grid on; title('d');xlabel('tiempo [seg]'); grid on;