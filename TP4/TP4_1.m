...
figure(1);
subplot(3,1,1);plot(t,x,'.-k');title('Función temporal');xlabel('Tiempo [seg.]');
ylabel('$x_t$','interpreter','latex','Rotation',0);
subplot(3,1,2);plot(t,fixx(1:N));title('Autocorrelación');xlabel('Tiempo [seg.]');
...
figure(2);
subplot(3,1,1);plot(t,y,'.-k');title('Función temporal');xlabel('Tiempo [seg.]');
...
ylabel('$dB$','interpreter','latex','Rotation',0);
